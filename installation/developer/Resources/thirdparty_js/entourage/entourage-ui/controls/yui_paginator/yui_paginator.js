	...
	create: function()
	{
		...
		*/		
		...
		this.rowsPerPage = function(value)
		{
			...
			this.pager.setState({rowsPerPage:parseInt(this.options.rowsPerPage)})
			this.pager.render();
		}  
		this.page = function(value)
		{
			this.options.initialPage = App.getActionValue(value,'page',this.options.initialPage)
			this.pager.setState({page:parseInt(this.options.initialPage)})
			this.pager.render();
		}  
		this.totalRecords = function(value)
		{
			...
			this.pager.setState({totalRecords:parseInt(this.options.totalRecords)})
			this.pager.render();
		...
		this.update = function(value)
		{
			...
			this.options.initialPage = App.getActionValue(value,'page',this.options.initialPage)
			this.options.totalRecords = App.getActionValue(value,'totalRecords',this.options.totalRecords);
			this.pager.setState({rowsPerPage:parseInt(this.options.rowsPerPage),page:parseInt(this.options.initialPage),totalRecords:parseInt(this.options.totalRecords)})
			this.pager.render();
