...
#ifndef WebKitUIDelegate_h
#define WebKitUIDelegate_h
...
class WebKitUIDelegate : public IWebUIDelegate2, IWebUIDelegatePrivate {
public:
	WebKitUIDelegate(UserWindowWin *window);
