describe("UI Window Tests",{
	...
	test_window_open_with_url_as_async: function(test)
	{
	...
	test_window_open_with_name_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_fullscreen_yes_as_async: function(test)
	{
	...
	test_window_open_fullscreen_no_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_fullscreen_1_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_fullscreen_0_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_height_100_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_width_100_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_resizable_1_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_resizable_0_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_resizable_true_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_resizable_false_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_left_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_top_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
	...
	test_window_open_multiple_props_as_async: function(test)
	{
		this.async_window_open(test, function(w)
		{
			value_of(w).should_be_object();
